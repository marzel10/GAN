...
fprintf('Enter the panel index:\n');
panel_idx = str2double(input('> ', 's'));
datapath = fullfile(projectRoot, 'data', sprintf('States_%d.mat', panel_idx));
...
modelFile_dir = dir(fullfile(net_folder, sprintf('%dp*.mat', path_idx)));
modelFile = fullfile(modelFile_dir(1).folder, modelFile_dir(1).name);
