...
from python_project.fc_AE import build_deep_CNN_network, build_deep_fully_connected_network
...
def build_model(hp, model_type="fc_AE"):
    ...
    if model_type == "fc_AE":
        ...
        params = {
            ...
            "filter2": hp.Choice("filter2", values=[64, 128, 256]),
...
def run_bayesian_optimization(
    ...
    best_model, _, _, model_info, _, _, _, _, _, _, _ = model_train(model_type, params=best_params, seed=seed)
...
fig3_cnn, axes3_cnn = plt.subplots(2, 5)
...
fig4_cnn, axes4_cnn = plt.subplots(2, 5)
