classdef GAN < nnet.layer.Layer ...
    ...
    methods
        ...
        function layer = GAN(name,inputsize,outputsize,adj,type)
            
            layer.Weights = rand(outputsize,inputsize);
            layer.Bias = rand(size(adj,1),outputsize);  % Row vector for broadcasting
        ...
        function varargout = predict(layer,X)
            ...
            for b = 1:batch_size
                ...
                Y(:,:,b) = layer.adj * Y(:,:,b); % [num_nodes, output_dim]
            end
