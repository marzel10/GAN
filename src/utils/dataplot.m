...
if nFreq == 0
    ...
    for i = 1:nFreq
        try
            ...
            bmk = freqArr(i).Pair_idx(1).Banchmark_Amplitude;
            ...
            plot(bmk, 'LineWidth', 1.2, 'DisplayName', 'Banchmark\_Amplitude');
    ...
    for i = 1:nFreq
        try
            ...
            p2 = plot(abs(fft(bmk)), 'LineWidth', 1.2, 'DisplayName', 'Banchmark\_Amplitude Spectrum');
            grid on; legend('show', 'Location', 'best');
